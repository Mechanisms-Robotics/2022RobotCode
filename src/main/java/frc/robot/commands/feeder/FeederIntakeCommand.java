...
public class FeederIntakeCommand extends CommandBase {
    ...
    public void execute() {
        ...
        if (ballDetected && !feeder.getLowSensor()) {
            ...
            // If we detected a ball and there is now one in front of the low sensor but not in front of the entry sensor
            ...
            // If we have detected a ball and there is one in front of the low sensor but not in front of the high sensor
