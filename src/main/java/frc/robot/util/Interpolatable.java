...
public interface Interpolatable<T> {
   ...
   * less than x less than 1, the return value should be interpolated proportionally between the
   * two.
   *
   * @param other The value of the upper bound
   * @param x The requested value. Should be between 0 and 1.
   * @return Interpolable of type T The estimated average between the surrounding data
   */
